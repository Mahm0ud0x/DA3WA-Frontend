...
export const DEFAULT_INVITATION_DETAILS: InvitationDetails = {
  firstName: "سارة",
  secondName: "أحمد",
  dateLine: "الأحد · 23 يوليو 2028 · 17:00",
  day: "23",
  month: "يوليو",
  monthEn: "July",
  year: "2028",
  ...
  weekdayEn: "Sunday",
  time: "17:00",
  venueTitle: ["Nile", "plaza"],
  locationImage: "/hcover1.webp",
  mapsUrl: "https://maps.app.goo.gl/P2DycaCa3JSUoUR6A",
  address: ["Dokki", "Giza"],
...
export const QURAN_INVITATION_DETAILS: InvitationDetails = {
  firstName: "إسلام",
  secondName: "منى",
  dateLine: "الثلاثاء · 12 ديسمبر 2028 · 16:00",
  day: "12",
  month: "ديسمبر",
  monthEn: "December",
  year: "2028",
